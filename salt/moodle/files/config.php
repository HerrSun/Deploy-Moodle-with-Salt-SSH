...
$CFG->dbtype    = '{{ moodle['dbtype'] }}';      // 'pgsql', 'mariadb', 'mysqli', 'auroramysql', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = 'localhost';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = '{{ postgresql['dbname'] }}';     // database name, eg moodle
$CFG->dbuser    = '{{ postgresql['dbuser'] }}';   // your database username
$CFG->dbpass    = '{{ postgresql['dbpass'] }}';   // your database password
